"""
Module: path_finder.py
Purpose: Implements path finding algorithms and network topology analysis.
Functions:
- build_links: Creates network topology from router information
- build_graph: Converts topology to graph representation
- find_paths: Finds primary and alternate paths between routers
"""
...
def find_paths(graph, start, goal, max_paths=2):
    ...
    Returns:
        list: List of paths, each path is a list of router names
    """
    paths = []
    visited = set()
