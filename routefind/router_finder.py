"""
routefind/router_finder.py
-------------------------
Router finding and information utilities for network automation web app.
Provides functions to locate routers/interfaces for given IPs and to retrieve detailed router information, including interfaces and routes.
"""
...
def get_router_info(router_ip, port=NETCONF_PORT, username=NETCONF_USERNAME, password=NETCONF_PASSWORD):
    """
    Get detailed information about a router, including interfaces and routes.
    ...
    Returns:
        dict: Router information including interfaces and routes, or None if not found.
    """
...
def find_source_and_dest_routers(source_ip, dest_ip):
    ...
    Returns:
        dict: Dictionary with 'source' and 'destination' keys, each mapping to the router info tuple or None.
    """
    return {
