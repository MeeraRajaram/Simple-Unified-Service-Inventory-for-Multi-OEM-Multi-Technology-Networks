...
Purpose: Provides functions for generating network topology visualizations for the web interface.
Functions:
- generate_network_layout: Creates layout positions for network visualization
- create_path_visualization: Generates visualization data for paths
"""
