...
def build_proto_routes_and_ospfdb():
    # Load INIP
    ...
    for src_router, src_iface, protocol, dest, dest_iface, next_hop in proto_rows:
        ...
        # For OSPF, deduplicate links (only one direction)
    ...
    # Use proto_routes_entries and rib_db.sqlite3
    ospf_neighbors = set()
